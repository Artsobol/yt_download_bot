...
def get_video_and_audio_stream(yt: YouTube, video_itag: int, audio_itag: int = 140) -> tuple[
    PytubeStream, PytubeStream]:
...
def check_valid_video_and_audio_size(video_stream: PytubeStream, audio_stream: PytubeStream, max_size: int = FileSize.MAX_SIZE) -> bool:
